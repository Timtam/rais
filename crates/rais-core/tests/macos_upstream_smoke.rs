...
//! `cargo test -p rais-core --test macos_upstream_smoke -- --ignored` on the
//! macOS runner.
//!
...
use rais_core::artifact::resolve_latest_artifacts;
...
use rais_core::package::{PACKAGE_OSARA, PACKAGE_REAKONTROL, PACKAGE_REAPER, PACKAGE_SWS};
use rais_core::receipt::load_install_state;
use rais_core::setup::{SetupOptions, execute_resolved_setup_operation};
